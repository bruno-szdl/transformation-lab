...
- **og:type**: `website`
- **og:url**: `https://transformation-lab.datagym.io`
...
3. **Update `index.html`**:
   ```html
   <meta property="og:image" content="https://transformation-lab.datagym.io/og-image.png" />
   ```

4. **Test the result**:
   - Use [Open Graph Debugger](https://www.opengraph.xyz/?url=https://transformation-lab.datagym.io)
...
<url>
  <loc>https://transformation-lab.datagym.io/#/lesson/5</loc>
...
- [ ] Test social preview with [OG Debugger](https://www.opengraph.xyz/?url=https://transformation-lab.datagym.io)
- [ ] Verify robots.txt is accessible: `https://transformation-lab.datagym.io/robots.txt`
- [ ] Verify sitemap.xml is accessible: `https://transformation-lab.datagym.io/sitemap.xml`
- [ ] Verify og-image is accessible: `https://transformation-lab.datagym.io/og-image.png` (or .svg)
