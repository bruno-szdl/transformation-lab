...
- [ ] Verify robots.txt is served: https://transformation-lab.datagym.io/robots.txt
- [ ] Verify sitemap.xml is served: https://transformation-lab.datagym.io/sitemap.xml
